import { Info, ArrowUpRight, Flame, Copy } from 'lucide-react'
  ...
  return (
    <div className="bg-[#0c0c0c] border border-[#222] rounded-xl p-6 h-full flex flex-col">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-3xl font-bold text-white">1,245.68</span>
            <span className="text-sm text-[#71717a] font-medium">USDC</span>
          </div>
          <div className="text-xs text-[#71717a] mt-1">≈ $1,245.68</div>
        </div>
        
        <div className="text-right">
          <div className="text-sm font-medium text-[#71717a] mb-1">Available to Deploy</div>
          <div className="flex items-baseline gap-1.5 justify-end">
            <span className="text-xl font-bold text-white">245.68</span>
            <span className="text-xs text-[#71717a] font-medium">USDC</span>
          </div>
          <button className="mt-3 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-bold py-2 px-5 rounded transition-colors shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_20px_rgba(16,185,129,0.5)]">
            Deposit
          </button>
        </div>
      </div>
      ...
      <div className="bg-[#111] border border-[#222] rounded-lg p-4 mb-6 relative overflow-hidden group">
        <div className="absolute right-0 top-0 w-32 h-32 bg-emerald-500/10 blur-3xl -mr-10 -mt-10 rounded-full"></div>
        <div className="relative z-10 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#71717a] max-w-[200px]">
              Your agent is monitoring markets and executing trades.
            </p>
          </div>
          <div className="w-14 h-14 bg-black border border-[#333] rounded-full flex items-center justify-center relative shadow-[0_0_20px_rgba(16,185,129,0.2)]">
            <div className="absolute inset-0 rounded-full border border-emerald-500/30 animate-ping" style={{ animationDuration: '3s' }}></div>
            {/* Robot Face simple svg */}
      ...
      <div className="mt-auto">
        <div className="flex items-center gap-1.5 mb-3">
          <span className="text-sm font-bold text-white">Trading Mode</span>
          <Info size={14} className="text-[#71717a]" />
        </div>
        
        <div className="grid grid-cols-2 gap-3">
          <button className="bg-emerald-500/10 border border-emerald-500/40 rounded-lg p-3 text-left transition-all hover:bg-emerald-500/20 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="text-[10px] text-[#a1a1aa] mb-3">Copy top traders' positions</div>
          ...
          <button className="bg-[#111] border border-[#222] rounded-lg p-3 text-left transition-all hover:border-[#333] group">
            <div className="flex items-center gap-2 text-[#ef4444] font-bold mb-1 opacity-70 group-hover:opacity-100 transition-opacity">
              <Flame size={16} />
              Rebel Mode
            </div>
            <div className="text-[10px] text-[#71717a] mb-3">Take opposite positions</div>
            <div className="flex items-center justify-between text-[#71717a]">
              <span className="text-xs">Inactive</span>
              <div className="w-4 h-4 rounded-full border-2 border-[#333]"></div>
            </div>
          </button>
        </div>
      </div>
