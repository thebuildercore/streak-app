    ...
    <div className="bg-[#0c0c0c] border border-[#222] rounded-xl p-6 h-full flex flex-col">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <div className="text-xs text-[#71717a] mt-1">≈ ${balanceLoading ? '...' : parseFloat(balance).toFixed(2)}</div>
        </div>
      ...
      <div className="bg-[#111] border border-[#222] rounded-lg p-4 mb-6 relative overflow-hidden group">
        <div className={`absolute right-0 top-0 w-32 h-32 blur-3xl -mr-10 -mt-10 rounded-full transition-colors ${
          isVerified ? 'bg-emerald-500/10' : 'bg-[#ef4444]/10'
        }`}></div>
